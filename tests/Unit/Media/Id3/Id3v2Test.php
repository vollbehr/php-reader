...
final class Id3v2Test extends TestCase
{
     ...
     * @covers ::addFrame
     */
    public function testAddsFrameAlignsEncodingWithTagVersion(): void
    {
        $id3v23 = new Id3v2(['version' => 3.0]);
        $frame23 = new Tcon();
        $frame23->setText("Caf\u{00E9}");

        $id3v23->addFrame($frame23);

        self::assertSame('iso-8859-1', $frame23->getEncoding());

        $id3v24 = new Id3v2(['version' => 4.0]);
        $frame24 = new Tcon();
        $frame24->setText('Hello World');

        $id3v24->addFrame($frame24);

        self::assertSame('utf-8', $frame24->getEncoding());
    }

    /**
     * @covers ::addFrame
     */
    public function testFallsBackToUtf16WhenIso88591CannotRepresentText(): void
    {
        $id3v23 = new Id3v2(['version' => 3.0]);
        $frame = new Tcon();
        $frame->setText("\u{041F}\u{0440}\u{0438}\u{0432}\u{0435}\u{0442}");

        $id3v23->addFrame($frame);

        self::assertSame('utf-16', $frame->getEncoding());
    }
