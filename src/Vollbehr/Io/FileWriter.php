...
class FileWriter extends Writer
{
    ...
    public function __construct($filename, $mode = null)
    {
        ...
        if (!is_string($filename) || $filename === '') {
            throw new Exception('Unable to open file for writing: ' . (string) $filename);
        }
        ...
        if (!$hasScheme && file_exists($filename) && !is_writable($filename)) {
        ...
        if ($fd === false) {
            ...
            $message = 'Unable to open file for writing: ' . $filename;
