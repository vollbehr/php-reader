 ...
 * The _MPEG location lookup table_ frame includes references that the
 ...
 */
final class Mllt extends \Vollbehr\Media\Id3\Frame
{
    /** @var integer */
    private $_frames;
    ...
    public function __construct($reader = null, &$options = [])
    {
        ...
        Transform::fromInt8($this->_data[8]);
        Transform::fromInt8($this->_data[9]);
