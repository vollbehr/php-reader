...
/**
 * The _File Properties Object_ defines the global characteristics of the
 * combined digital media streams found within the Data Object.
 * @author Sven Vollbehr
 */
final class FileProperties extends \Vollbehr\Media\Asf\BaseObject
{
    /**
     ...
     * containing a single audio stream and a _Minimum Data Packet Size_
     * field equal to the _Maximum Data Packet Size_ field, this flag shall
     ...
     * to 1 if the file contains a matching _Simple Index Object_ for each
     ...
     * {@see \Vollbehr\Media\Asf\BaseObject\Data Data Object}. The value of this field
     * is invalid if the broadcast flag bit in the flags field is set to 1.
     * @return integer
     */
     ...
     */
    public function setDataPacketsCount($dataPacketsCount): void
    {
     ...
     */
    public function setPlayDuration($playDuration): void
    {
     ...
     */
    public function setSendDuration($sendDuration): void
    {
     ...
     * file, in millisecond units. If this value is nonzero, the _Play
     * Duration_ field and all of the payload _Presentation Time_ fields
     ...
     * in millisecond units. If this value is nonzero, the _Play Duration_
     * field and all of the payload _Presentation Time_ fields have been
     ...
     */
    public function setPreroll($preroll): void
    {
    ...
    /**
     * Returns the minimum _Data Packet_ size in bytes. In general, the
     * value of this field is invalid if the broadcast flag bit in the flags
     * field is set to 1. However, the values for the _Minimum Data Packet
     * Size_ and _Maximum Data Packet Size_ fields shall be set to the
    ...
    /**
     * Sets the minimum _Data Packet_ size in bytes. In general, the value
     * of this field is invalid if the broadcast flag bit in the flags field is
     * set to 1. However, the values for the _Minimum Data Packet Size_ and
     * _Maximum Data Packet Size_ fields shall be set to the same value,
     * and this value should be set to the packet size, even when the broadcast
     * flag in the flags field is set to 1.
     * @param integer $minimumDataPacketSize The minimum _Data Packet_ size
     *        in bytes.
     */
    public function setMinimumDataPacketSize($minimumDataPacketSize): void
    {
        $this->_minimumDataPacketSize = $minimumDataPacketSize;
    }

    /**
     * Returns the maximum _Data Packet_ size in bytes. In general, the
     * value of this field is invalid if the broadcast flag bit in the flags
     * field is set to 1. However, the values for the _Minimum Data Packet
     * Size_ and _Maximum Data Packet Size_ fields shall be set to the
     * same value, and this value should be set to the packet size, even when
    ...
    /**
     * Sets the maximum _Data Packet_ size in bytes. In general, the value
     * of this field is invalid if the broadcast flag bit in the flags field is
     * set to 1. However, the values for the _Minimum Data Packet Size_ and
     * _Maximum Data Packet Size_ fields shall be set to the same value,
     * and this value should be set to the packet size, even when the broadcast
     * flag in the flags field is set to 1.
     * @param integer $maximumDataPacketSize The maximum _Data Packet_ size
     *        in bytes
     */
    public function setMaximumDataPacketSize($maximumDataPacketSize): void
    {
     ...
     *        per second.
     */
    public function setMaximumBitrate($maximumBitrate): void
    {
