...
final class Page
{
    ...
    private array $_segmentTable = [];

    private readonly int | float $_size;

    private readonly int | float $_headerSize;
    ...
    public function __construct(/** The reader object. */
        ...
        if ($this->_capturePattern != 'OggS') {
            ...
            throw new Exception('Not a valid Ogg bitstream');
        }
        $this->_streamStructureVersion = $this->_reader->readUInt8();
        if ($this->_streamStructureVersion != 0) {

            throw new Exception('Unsupported Ogg stream structure version');
        }
     ...
     * @return integer
     */
    final public function getHeaderTypeFlag()
    {
     ...
     * @return integer
     */
    final public function getGranulePosition()
    {
     ...
     * @return integer
     */
    final public function getBitstreamSerialNumber()
    {
     ...
     * @return integer
     */
    final public function getPageSequenceNumber()
    {
     ...
     * @return integer
     */
    final public function getCrcChecksum()
    {
     ...
     * @return integer
     */
    final public function getNumberPageSegments()
    {
     ...
     * @return integer
     */
    final public function getSegmentTable(): array
    {
     ...
     * @return integer
     */
    final public function getSize(): int | float
    {
        return $this->_size;
    }
     ...
     * @return integer
     */
    final public function getHeaderSize(): int | float
    {
     ...
     * @return integer
     */
    final public function getPageSize(): int | float
    {
