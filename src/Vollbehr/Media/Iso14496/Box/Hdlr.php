...
/**
 * The _Handler Reference Box_ is within a
 * {@see \Vollbehr\Media\Iso14496\Box\Mdia Media Box} declares the process by which
 ...
 * This box when present within a {@see \Vollbehr\Media\Iso14496\Box\Meta Meta Box},
 * declares the structure or format of the _meta_ box contents.
 * @author Sven Vollbehr
 */
final class Hdlr extends \Vollbehr\Media\Iso14496\FullBox
{
    /** @var string */
    ...
    public function __construct($reader = null, &$options = [])
    {
        ...
        $this->_name = $this->_reader->readString8($this->getOffset() + $this->getSize() -
     ...
     *   o _vide_ Video track
     *   o _soun_ Audio track
     *   o _hint_ Hint track
    ...
    *
     ...
     */
    public function setHandlerType($handlerType): void
    {
